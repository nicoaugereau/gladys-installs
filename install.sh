...
install_gladys_voice(){
    ...
    cd $ROOT_FOLDER
    sudo git clone https://github.com/GladysProject/gladys-voice gladys-voice
    cd $GLADYS_VOICE
    sudo yarn install
}
...
install_gladys_bluetooth(){
    ...
    cd $ROOT_FOLDER
    sudo git clone https://github.com/GladysProject/gladys-bluetooth gladys-bluetooth
    cd $GLADYS_BT
    sudo yarn install
